!function (a) {
    ...
    b.cache = {}, a.tpl = function (a, c, d) {
        ...
        var h = b;
        if ("string" != typeof d) {
            var i = a.extend({}, c, "object" == typeof d && d), j = !1;
    ...
    var c = '<div class="ui-loading-block show"><div class="ui-loading-cnt"><i class="ui-loading-bright"></i><p><%=content%></p></div></div>', d = {content: "锷犺浇涓?.."}, e = function (b, c, e) {
