...
//免费版表单增加按钮链接到付费测算
$GLOBALS['config']['ff_url']['bazijp']="https://yshi5.mizheba.net/?ac=bazijp";
$GLOBALS['config']['ff_url']['bazijp_t']="付费测算";
$GLOBALS['config']['ff_url']['hehun']="https://yshi5.mizheba.net/?ac=hehun";
$GLOBALS['config']['ff_url']['hehun_t']="付费测算";
$GLOBALS['config']['ff_url']['xmpd']="https://yshi5.mizheba.net/?ac=xmpd";
$GLOBALS['config']['ff_url']['xmpd_t']="付费测算";
$GLOBALS['config']['ff_url']['ffqm']="https://yshi5.mizheba.net/?ac=ffqm";
$GLOBALS['config']['ff_url']['ffqm_t']="付费测算";
$GLOBALS['config']['ff_url']['xmfx']="https://yshi5.mizheba.net/?ac=xmfx";
$GLOBALS['config']['ff_url']['xmfx_t']="付费测算";
$GLOBALS['config']['ff_url']['bazi']="https://yshi5.mizheba.net/?ac=bazi";
$GLOBALS['config']['ff_url']['bazi_t']="付费测算";
$GLOBALS['config']['ff_url']['hmjx']="https://yshi5.mizheba.net/?ac=hmjx";
