...
$cath_url = array('http://www.114ymw.com/shengxiao/shu/','http://www.114ymw.com/shengxiao/niu/','http://www.114ymw.com/shengxiao/hu/','http://www.114ymw.com/shengxiao/tu/','http://www.114ymw.com/shengxiao/long/','http://www.114ymw.com/shengxiao/she/','http://www.114ymw.com/shengxiao/ma/','http://www.114ymw.com/shengxiao/yang/','http://www.114ymw.com/shengxiao/hou/','http://www.114ymw.com/shengxiao/ji/','http://www.114ymw.com/shengxiao/gou/','http://www.114ymw.com/shengxiao/zhu/');
...
for($i=0;$i<count($url_arr);$i++){
		...
		if($title){
			...
			if($data['id']==''){
				$sql="INSERT INTO `news_data` (`title`, `content`,`img`, `tid`,`shorttxt`,`category`,`contentKeyword`) VALUES ('".$title."', '".$content."','".$img."', '".$tid."','".$shorttxt."','".$k."','".$v."')";
				if($content==''){
					_wlog("空内容\r\n");
				}else{
					if(db::query($sql)){
