...
$category_array = array(1=>'白羊座', 2=>'金牛座', 3=>'双子座', 4=>'巨蟹座', 5=>'狮子座', 6=>'处女座', 7=>'天秤座', 8=>'天蝎座', 9=>'射手座', 10=>'摩羯座', 11=>'水瓶座', 12=>'双鱼座');
$cath_url = array('http://www.114ymw.com/astro/aries/l_2.html','http://www.114ymw.com/astro/taurus/l_2.html','http://www.114ymw.com/astro/gemini/l_2.html','http://www.114ymw.com/astro/cancer/l_2.html','http://www.114ymw.com/astro/leo/l_2.html','http://www.114ymw.com/astro/virgo/l_2.html','http://www.114ymw.com/astro/libra/l_2.html','http://www.114ymw.com/astro/scorpio/l_2.html','http://www.114ymw.com/astro/sagittarius/l_2.html','http://www.114ymw.com/astro/capricorn/l_2.html','http://www.114ymw.com/astro/aquarius/l_2.html','http://www.114ymw.com/astro/pisces/l_2.html');
...
for($i=0;$i<count($url_arr);$i++){
		...
		if(false === stripos($url_arr[$i], 'http')){
			$url =	'http://www.114ymw.com'.$url_arr[$i];
		}else{
			$url = 	$url_arr[$i];
		}
		...
		if($title){
			$cls = new mod_cai();
			$cc = $cls->replace($cc,'http://www.114ymw.com');
...
function _wlog($msg,$isEcho=true,$isExit=false)
{
    ...
    error_log($msg."\r\n",3,$path_log . 'xingzuowuXINGZUO.log');
    //if($isExit)exit();
}
