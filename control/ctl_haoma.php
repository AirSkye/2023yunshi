...
class ctl_haoma
{
	...
	public function shouji(){
		...
		$tpl     = 'index/haoma/shouji_form.tpl';
		$content = tpl::fetch($tpl);
		exit($content);
	}
	...
	public function dianhua(){
		...
		$tpl     = 'index/haoma/dianhua_form.tpl';
		$content = tpl::fetch($tpl);
		exit($content);
	}
	...
	public function shenfenzheng(){
		...
		*/	
		...
		$tpl     = 'index/haoma/shenfenzheng_form.tpl';
		$content = tpl::fetch($tpl);
		exit($content);
	}
	...
	public function chepai(){
		...
		$tpl     = 'index/haoma/chepai_form.tpl';
		$content = tpl::fetch($tpl);
		exit($content);
	}
	...
	public function shengrimima(){
		...
		if(req::item('m')){ 
			...
			tpl::assign('seo',$seo);
			$tpl     = 'index/haoma/srmm_find.tpl';
		}
		else
		{
			$tpl     = 'index/haoma/srmm_from.tpl';
		}
		$content = tpl::fetch($tpl);
		exit($content);
	}
	...
	public function shengrihua(){
		...
		if(req::item('m')!=''){ 
			...
			tpl::assign('seo',$seo);
			$tpl     = 'index/haoma/shengrihua_find.tpl';
		}
		else
		{
			$tpl     = 'index/haoma/shengrihua_from.tpl';
		}
		$content = tpl::fetch($tpl);
		exit($content);
	}
	...
	public function shengrishu(){
		...
		if(req::item('m')!=''){ 
			...
			tpl::assign('seo',$seo);
			$tpl     = 'index/haoma/shengrishu_find.tpl';
		}
		else
		{
			$tpl     = 'index/haoma/shengrishu_from.tpl';
		}
		$content = tpl::fetch($tpl);
		exit($content);
	}
	...
	public function chushengri(){
		...
		if(req::item('d')!=''){ 
			...
			tpl::assign('seo',$seo);
			$tpl     = 'index/haoma/chushengri_find.tpl';
		}
		else
		{
			$tpl     = 'index/haoma/chushengri_from.tpl';
		}
		$content = tpl::fetch($tpl);
		exit($content);
	}
