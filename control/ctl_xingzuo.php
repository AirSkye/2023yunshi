...
class ctl_xingzuo
{
	...
	public function ssxz(){
		...
		$topic = mod_topic::get_topic('364',$tid);
		...
		if($m==''){
			$tpl     = 'index/xingzuo/shangsheng.tpl';
			...
			$tpl     = 'index/xingzuo/shangsheng_find.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	...
	*/
	...
	public function xingzuoyunshi(){
		...
		$tpl     = 'index/xingzuo/xingzuoyunshi.tpl';
		$content = tpl::fetch($tpl);
		exit($content);
	}
