...
class ctl_suanming
{
    ...
    public function sm_form(){
		...
		//echo $base;
		$topic = mod_topic::get_topic('357',$base);
        ...
        if($xing=='' && empty($_SESSION['yourss'])){
            ...
            $tpl     = 'index/suanming/suanming_form.tpl';
    ...
    public function fscs(){
		...
		$topic = mod_topic::get_topic('357',$tid);
        tpl::assign('topic',$topic);
        ...
        if(is_numeric($xb)){
            ...
            if($xb!='0' && $chaoxiang!='0' && $nianfen!='0'){
                ...
                $tpl     = 'index/suanming/fengshui_find.tpl';
                $content = tpl::fetch($tpl);
                exit($content);
            }else{
                $strText='请把信息填写完成';
            ...
            $tpl     = 'index/suanming/fengshui_form.tpl';
            $content = tpl::fetch($tpl);
            exit($content);
