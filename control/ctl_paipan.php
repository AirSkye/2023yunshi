...
class ctl_paipan
{
    ...
    public $cache_prefix = 'yshi5.mizheba.net';
	...
	public function bazi(){
		...
		$topic = mod_topic::get_topic('359',$tid);
		...
		if(req::item('name'))
		{
			...
			$tpl     = 'index/paipan/bazi_find.tpl';
		...
		{
			$tpl     = 'index/paipan/bazi_form.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	}
	...
	public function ziwei(){
		...
		if(req::item('name'))
		{
			...
			$tpl     = 'index/paipan/ziwei_find.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
		else
		{
			$tpl     = 'index/paipan/ziwei_form.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	}
	...
	public function xuankongfeixing(){
		...
		if(req::item('gm'))
		{
			...
			$tpl     = 'index/paipan/xkfx_find.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
		else
		{
			$tpl     = 'index/paipan/xkfx_form.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	}
	...
	public function liuren(){
		...
		if(req::item('name'))
		{
			...
			$tpl     = 'index/paipan/liuren_find.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
		else
		{
			$tpl     = 'index/paipan/liuren_form.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	}
	...
	public function liuyao(){
		...
		if(req::item('name'))
		{
			...
			$tpl     = 'index/paipan/liuyao_find.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
		else
		{
			$tpl     = 'index/paipan/liuyao_form.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	}
	...
	public function qimendunjia(){
		...
		if(req::item('name'))
		{
			...
			tpl::assign('data',$data);
			$tpl     = 'index/paipan/qimendunjia_find.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
		else
		{
			$tpl     = 'index/paipan/qimendunjia_form.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	}
	...
	public function xingpan(){
		...
		if(req::item('name'))
		{
			...
			$tpl     = 'index/paipan/xingpan_find.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		...
		{
			$tpl     = 'index/paipan/xingpan_form.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	}
