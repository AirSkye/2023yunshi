...
class ctl_news
{
    ...
    */
	...
	public function search(){
		...
		if($q=='' || $q=='请输入关键字搜索'){
			die("<script> alert('请输入关键字');parent.location.href='http://yshi5.mizheba.net/';</script>");
		}
		...
		if (!db::num_rows()){
				die("<script> alert('没有相关内容');parent.location.href='http://yshi5.mizheba.net/baike';</script>");
        }else{
