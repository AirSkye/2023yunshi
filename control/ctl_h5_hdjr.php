...
class ctl_h5_hdjr
{
	...
	public function index()
	{
     ...
     $hdjr[ddd3]=$ddd3[0];
      ...
      if($cl==1){
        ...
        $tpl     = 'index/huangli/index_cl.tpl';
      }else{
        header("Access-Control-Allow-Origin:*");
		header("Access-Control-Allow-Methods:GET,POST");
      	$tpl     = 'index/huangli/index_cl.tpl';
	...
	*/
	function zeri(){
		...
		$path = mod_index::this_path($tid);
		tpl::assign('path',$path);
		$topic = mod_topic::get_topic_h5('363',$tid);
        tpl::assign('topic',$topic);
		$seo = mod_topic::seo_info($tid);
		tpl::assign('seo',$seo);
	...
	function huanglijieshi(){
		...
		$tpl     = 'h5/huangli/huanglijieshi.tpl';
		$content = tpl::fetch($tpl);
		exit($content);
	}
	...
	public function jrhl(){
        $date = date('Y-n-j', time());
		$hdjr=cls_laohuangli::get_hdjr($date);
		echo "document.write('<span class=\"gregorian\" id=\"riqi\"><i></i>".$hdjr['gongli']."</span><span class=\"lunar\" id=\"nongli\">".$hdjr['nongli']."</span></div><div class=\"ecliptic_act ecliptic_act_s1\"><div id=\"ecliptic_prop1\" class=\"prop\"><span class=\"item\"><a target=\"_blank\" href=\"/hdjr/".$date."\" class=\"in\">".$hdjr['yi']."</a></span></div><span class=\"icon\"></span></div><div class=\"ecliptic_act ecliptic_act_s2\"><div id=\"ecliptic_prop2\" class=\"prop\"><span class=\"item\"><a target=\"_blank\" href=\"/hdjr/".$date."\" class=\"in\">".$hdjr['ji']."</a></span></div><span class=\"icon\"></span></div><div class=\"ecliptic_act ecliptic_act_s3\"><div id=\"ecliptic_prop3\" class=\"prop\"><span class=\"item\"><a class=\"in\" target=\"_blank\" href=\"/hdjr/".$date."\">".$hdjr['chong']."</a></span></div><span class=\"icon\"></span>');";
		exit;
	}
