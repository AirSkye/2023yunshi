...
class ctl_xingming
{
	...
	public function qiming(){
		...
		if(request('xing')!='' || request('xid')!='')
		{
			...
			$tpl     = 'index/xingming/xingming_list.tpl';
			...
			$tpl     = 'index/xingming/qiming_index.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	...
	public function dzqm(){
		...
		if(request('xing'))
		{
			...
			$tpl     = 'index/xingming/dzqm_list.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		...
		{
			$tpl     = 'index/xingming/dzqm_form.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	} 
	...
	public function xmpd(){
		...
		if(request('name1'))
		{
			...
			$tpl     = 'index/xingming/xmpd_find.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		...
		{
			$tpl     = 'index/xingming/xmpd_form.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	}
	...
	public function gsqm(){
		...
		if(request('name',''))
		{
			...
			$tpl     = 'index/xingming/gsqm_find.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
		else
		{
			$tpl     = 'index/xingming/gsqm_form.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	...
	public function xmfx(){
		...
		{	
			...
			$tpl     = 'index/xingming/xmfx_find.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
		else
		{
			$tpl     = 'index/xingming/xmfx_form.tpl';
			$content = tpl::fetch($tpl);
			exit($content);
		}
	}
