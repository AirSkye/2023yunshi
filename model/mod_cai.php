...
class mod_cai extends mod_base
{
	...
	public function xingzuowu_replace($content){
		...
		$content = str_replace("微信公众号：kaiyunkj",'文章来源：远方科技',$content);
	...
	public function zgjmorg($content){
		$content = str_replace("cqapi.xlibbs.com",'03ky.com',$content);
		$content = str_replace("cqapi.xlibbs.com",'cqapi.xlibbs.com',$content);
	...
	public function shenponeirong($url){
		...
		//$img_list = self::get_http_img($cc,'ALL','http://www.yiabs.com');
		//if(is_array($img_list['httpimg'])){
