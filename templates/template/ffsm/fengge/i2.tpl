...
<link rel="stylesheet" type="text/css" href="statics/ffsm_2020/index/css/reset_1.css">
<link rel="stylesheet" type="text/css" href="statics/ffsm_2020/index/css/common_1.css">
<link rel="stylesheet" type="text/css" href="statics/ffsm_2020/index/css/font_1.css">
<{include file='./ffsm/wx_share.tpl'}>
<script src="statics/ffsm_2020/index/js/modular_1.js"></script>
<script src="statics/ffsm_2020/index/js/rem_1.js"></script>
<script src="statics/ffsm_2020/index/js/vue.min_1.js"></script>
<script src="statics/ffsm_2020/index/js/jquery_1.js"></script>
<title>真人在线算命,八字测算命理咨询-<{$zhanming}></title>
...
<body class="navbar-fixed" class="v-cloak">
	<div id="container">
		<link rel="stylesheet" type="text/css" href="statics/ffsm_2020/index/css/reckon-index_1.css">
		<div id="vue_app" v-cloak>
			<link rel="stylesheet" type="text/css" href="statics/ffsm_2020/index/css/header_1.css">
			<div class="container">
					...
					<li v-for="(item,key) in list" :key="key" v-cloak><a
						:href="item.jump_url"> <img
							...
							<div class="info flex flex-center flex-pack-justify">
								...
								<img
									:src="' statics/ffsm_2020/index/images/' + item.theme_btn"
				...
				<div class="bottom-banner">
					<img src="statics/ffsm_2020/index/picture/ny-bottombanner_1.png" alt="图片" width="100%">
				</div>
			</div>
		</div>
		<script>
