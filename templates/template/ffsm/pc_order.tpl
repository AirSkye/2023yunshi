...
<head>
<meta charset="UTF-8"/>
<title><{$names.username}>的八字综合详批-<{$zhanming}></title>
...
<a class="public_h_home" href="/"><img src="/statics/ffsm/pc/image/logo.png" alt="在线测试" /></a><a href="?ac=history" class="public_h_menu">订单历史记录</a>
</header>
...
<div class="time-item">
	...
	<div class="obp_tip">
		已有<span>23302574</span>人进行了测试知晓了自己<span>事业财运、婚姻情感</span>的情况，并根据老师建议做出调整，产生显著效果，<span>96.8%</span>用户觉得本测试有帮助！
	</div>
</div>
