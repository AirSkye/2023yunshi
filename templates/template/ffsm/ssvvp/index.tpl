...
<div class="public_banner"  id="submit2">
	<img src="/statics/ffsm/ssvvp/img/banner.png" alt="实时女女配"/>
</div>



<div class="public_bg_from">
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=ssvvp" name="login" method="post" onSubmit="return checkForm();">
		...
		<div class="form_bottom_txt">
			<span>已为<b>6708</b>人查看2022年实时闺蜜情</span>
		</div>
	</form>
...
<div class="public_bg_color">
			...
			<div class="im_info_c">
					你可知，姐妹之间也有匹配指数。在匹配值高的时候，双方的忠诚度、好感度都更浓厚，低时可就要小心啦！通过多项人格属性值、实时匹配值，从而去辨别，她是否就是你真正的好闺蜜！（防火防盗防？？？别说没告诉你哟~）
更能知晓自身优势和短板，在正确的时间点，利用自己优势，带动运势的提升。
				</div>
</div>
<div class="public_bg_color">
			<div class="im_info_t">
...
<script src="statics/suanming_ssvvp.js"></script>
<{include file='./ffsm/ssvvp/footer_jg.tpl'}>
