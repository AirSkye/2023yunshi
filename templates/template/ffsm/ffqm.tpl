...
<head>
<meta charset="UTF-8"/>
<title>宝宝起名_为宝宝起一个好名字-<{$zhanming}>在线起名</title>
<meta name="Keywords" content="宝宝起名,宝宝取名,宝宝起名网,在线起名" />
<meta name="Description" content="新生宝宝在线起名，为宝宝起一个好名字，为超过百万家庭孩子起名，涵盖丰富的取名大全，让更多男孩女孩起名、婴儿取名、小孩子起到适合自己八字的名字，欢迎来到起名字网。" />
...
<div class="public_banner" id="submit2">
	<img src="statics/ffsm/ffqm/images/banner.png" alt="宝宝起名"/>
</div>
