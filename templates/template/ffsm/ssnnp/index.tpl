...
<link href="/statics/ffsm/ssnnp/css/wap.css" rel="stylesheet" type="text/css"/>
<link href="/statics/ffsm/ssnnp/css/style.min.css" rel="stylesheet" type="text/css"/>
<link rel="stylesheet" type="text/css" href="/statics/ffsm/bazimf/sty.css"/>
<{include file='./ffsm/wx_share.tpl'}>
<script src="/statics/ffsm/ssnnp/js/vue.min.js"></script>
<script src="/statics/ffsm/ssnnp/js/jquery.min.js"></script>
<script src="statics/ffsm/public/js/require/require.min.js"></script>
<script src="statics/ffsm/public/js/common.min.js"></script>
<link rel="stylesheet" href="/statics/ffsm/ssnnp/css/public.css">
<link rel="stylesheet" href="/statics/ffsm/ssnnp/layui/css/layui.css"> 
...
<body>
<script src="/statics/ffsm/ssnnp/layui/layui.js"></script>
<div id="order">
<div class="public_header">
<h1 class="public_h_con">实时兄弟情</h1>
...
<{if $gundong}><div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/ssnnp/img/laba.png" /></span><p class="inner"><{$gundong}></p></div><{/if}>
...
<div class="public_banner"  id="submit2">
	<img src="/statics/ffsm/ssnnp/img/banner.png" alt="实时男男配"/>
</div>



<div class="public_bg_from">
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=ssnnp" name="login" method="post" onSubmit="return checkForm();">
		...
		<div class="form_bottom_txt">
			<span>已为<b>6539</b>人查看2022年实时兄弟情</span>
		</div>
	</form>
	
</div>

<{include file='./ffsm/ssnnp/ss_icon.tpl'}>

<div class="public_bg_color">
			<div class="im_info_t" >
			他，是真兄弟吗？
			</div>
			<div class="im_info_c" style="font-size: 0.35rem;">
					你可知，男人与男人之间，也有匹配指数。在匹配值高的时候，双方的忠诚度、好感度都更浓厚，通过多项人格属性值、实时匹配值，就能发现两个人相互喜欢的程度，拥有纯纯的兄弟情~
				</div>
</div>
<div class="public_bg_color">
			<div class="im_info_t">
...
<script src="statics/suanming_ssnnp.js"></script>
<{include file='./ffsm/ssnnp/footer_jg.tpl'}>
