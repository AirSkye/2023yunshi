...
<link href="/statics/ffsm/ssnvp/css/style.min.css" rel="stylesheet" type="text/css"/>
...
<div class="public_banner"  id="submit2">
	<img src="/statics/ffsm/ssnvp/img/banner.png" alt="实时男女配"/>
</div>



<div class="public_bg_from">
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=ssnvp" name="login" method="post" onSubmit="return checkForm();">
		...
		<div class="form_bottom_txt">
			<span>已为<b>5408</b>人查看2022年实时男女配</span>
		</div>
	</form>
...
<div class="public_bg_color">
			...
			<div class="im_info_c">
<p>人海茫茫，TA是不是你的唯一？在一起的可能大吗？你们的先天匹配值，早已注定。但在实际运行的时间，匹配值高的时候，你们更易互相吸引，走到一起。熟练运用你们的匹配度，你就能更轻松的拥有TA~</p>
...
<script src="statics/suanming_ssnvp.js"></script>
