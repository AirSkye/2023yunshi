...
<div class="public_orders_search">
	<div class="public_os_info">
		温馨提示：已经付款的用户请输入订单号查询测试结果！如未正常显示请添加微信号【<{$weixinhao}>】反馈！
	</div>
	<ul class="problem_feedback">
		<li><a class="after_sales_link" href="http://wpa.qq.com/msgrd?v=3&uin=2452818852&site=qq:2452818852&menu=yes" hidetxt="问题反馈">问题反馈</a></li>
