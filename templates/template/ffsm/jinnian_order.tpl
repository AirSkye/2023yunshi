...
<head>
<meta charset="UTF-8"/>
<title>2023兔年运程详批-<{$zhanming}></title>
...
<h1 class="public_h_con">兔年运势详批</h1>
...
<div class="order_sn"  id="submit2">订单号：<{$oid}></div>
  <div class="oi_data">
    <div class="oi_userinfo">
      <p>服务项目：2023流年运详批</p>
      <p>用户信息：<span><{$names.username}>(<{if $names.gender==1}>男<{else}>女<{/if}>)</span></p>
      <p>出生日期：<{$names.y}>年<{$names.m}>月<{$names.d}>日<{if $names.h>=0}><{$names.h}><{else}>未知<{/if}>时</p>
    </div>
    <div class="oi_tip">已为<span>2395837</span>位用户提供服务，用户知晓了自己2023年的事业财富、婚姻情感的情况，有<span>98.7%</span>用户觉得本次分析对人生规划发展有帮助！</div>
  </div>
</div>
<div class="obp_pirce">
		<del>原价：￥168</del><em><strong>吉时特价：<span style="color:#fff;">￥<{$money}></span></strong></em>
<div class="time-item">
	<em>倒计时：</em>
...
<a class="analysis-option" href="#submit2">
  <li><label>五、2023年12个月运势分析 </label></li>
  <li><label>六、犯太岁化解太岁方法</label></li>
  <li><label>七、虎年行好运风水布局</label></li>
</a>
</div>
