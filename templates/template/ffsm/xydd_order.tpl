...
<html lang="en">
 <head> 
  <meta charset="utf-8" /> 
  <title>祈福明灯，孔明灯，许愿广场，在线专业测试_<{$zhanming}></title> 
  <meta name="viewport" content="width=device-width,initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover" /> 
  <meta name="apple-mobile-web-app-capable" content="yes" /> 
  <meta name="apple-touch-fullscreen" content="yes" /> 
  <meta name="keywords" content="祈福，许愿，愿望，孔明灯，许愿树，我要许愿，实现愿望" /> 
  <meta name="description" content="<{$zhanming}>专业在线祈福明灯！为您提供许愿及祈福平台，致力于实现每个人心中的美好愿望，灵机文化祈福明灯祝您早日实现您的美好愿望。" /> 
...
<{if $gundong}><div class="alert-marquee" id="alertMarquee"><p class="inner"><{$gundong}></p></div><{/if}>
      ...
      <section>
	   <form class="J_ajaxForm J_testFixedTop" id="submit1" action="/?ac=xydd&lantern_id=<{$lantern_id}>" name="login" method="post" onSubmit="return checkFormwei();">
        ...
        <div class="f-box">
         <ul class="form">
          ...
          <li class="clear">
           ...
           <div class="auto">
            <input type="text" id="birthday" data-input-id="b_input" class="Js_date" data-type="0" value="请选择出生日期" placeholder="请选择日期" data-toid-hour="birthday"   data-date="2023-1-1" readonly="" placeholder="请选择(必填)" />
           </div></li>
          <li class="textarea">
           <div class="label">
            您的愿望:
      ...
      <div class="new-comment mai_d">
       ...
       <div class="marquee-wrapper">
        <ul class="comment-list info-list-box" >
         <li><p class="user">订单号：KHFZOK***TIO76 女 25岁</p><p class="detail">2023要高考了，点一盏光明灯和文昌灯，祈求能考上心仪的大学！</p></li>
...
<script>
  ...
  <script type="text/javascript">
            ...
            function checkFormwei() {
                    
            var username = document.login.username.value;
            
             var str ='<{$weijinci}>';
             
             var weijinci = str.split(',');
            ...
            if (result){
                    layer.msg('含有违禁词');
                    $('.common-loading-layer').css('display','none');
...
$('.m-btn').click(function(){
        $('.common-loading-layer').css('display','block');
            setTimeout(function(){checkFormwei();},1000);
});
