...
<div class="public_tab_item">
	<form class="J_ajaxForm" action="/?ac=xmfx" method="post" id="submit1" onSubmit="return checkForm();" name="login">
        ...
        <input type="submit" value="" class="J_ajax_submit_btnsub">
		</div>
		<div class="product_introduction">
			...
			<div class="xmjm_unlock">
				<p class="public_red"><img src="/statics/ffsm/jieming/1/images/img_syt.jpg" alt="#"/>	</p>
				<p>	<img src="/statics/ffsm/jieming/1/images/commun.png" alt="#"/></p>
				<p>	<img src="/statics/ffsm/jieming/1/images/img_tupian4.png" alt="#"/></p>
				<p>	<img src="/statics/ffsm/jieming/1/images/img_tupian6.png" alt="#"/></p>
			</div>
		</div>
