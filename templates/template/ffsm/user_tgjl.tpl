...
<div class="aui-super-box">
  ...
  <div class="public_ddxx">
      <div class="public_k">
           <span class="public_des">[<{$i.type}>] <{$i.data.username}></span><span class="public_pyzt"><{if $i.status==1}><font color="#ff5e5e" >已付款</font><{else}>未付款<{/if}></span>      </div>
        <div class="public_k">
...
<script type="text/javascript" src="www.114ymw.com/yixue/api.php?mod=js&bid=84"></script>
</body>
</html>
