...
<meta name="description" content="<{$zhanming}>提供婚姻测试相关产品服务，解开婚姻与八字的姻缘关系，普渡每一个善信的有缘人，我们衷心祝愿您拥有幸福的婚姻生活。" />
...
<div class="index-form__title">立马为你揭开姻缘奥秘</div>
<div class="form_wrap">
	<form class="J_ajaxForm J_testFixedShow"  id="submit1" action="/?ac=yinyuancs" name="login" method="post" onSubmit="return checkForm();">
		...
		<div class="public_btn_s">
        	<a href="javascript:;" class="J_ajax_submit_btnsub"> 立即测试</a>
		</div>
	</form>
</div>
</div>
<div class="public_bg_wrap mt10">
  <div class="public_title">专业解答姻缘困惑</div>
  <div class="m-box__con">
  <div class="know_info">
    <img class="ki_img" src="/statics/ffsm/yunyincs/1/images/0_img_1.png" alt=""></div>
</div>
</div>
<div class="public_bg_wrap mt10">
  <div class="public_title">提前预知你的感情走势</div>
    <div class="m-box__con">
  <div class="know_info">
    <img class="ki_img" src="/statics/ffsm/yunyincs/1/images/0_img_2.png" alt=""></div>
	</div>
	  </div>
	<div class="public_bg_wrap mt10">
  <div class="public_title">献给想要脱单、结婚的你</div>
    <div class="m-box__con">
  <div class="know_info">
    <img class="ki_img" src="/statics/ffsm/yunyincs/1/images/0_img_3.png" alt=""></div>
</div>
</div>
</div>
...
<style type="text/css">
.ainuo_foot_nav{display: block; padding: 2px 0; background:#ff6080; position: fixed; bottom: 0; width: 100%; z-index: 99999;max-width: 640px;}
