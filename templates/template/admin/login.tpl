...
<body>
<h1>《114运势测算》测算程序后台登录<sup></sup></h1>
...
<div style="text-align:center;">
	<a href="https://www.114ymw.com/" target="_blank"><span style="font-size: 14px;color: #ffffff;margin-top: 30px;display: block;">忘记密码</span></a> 
</div>
</body></html>