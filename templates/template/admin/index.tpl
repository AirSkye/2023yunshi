...
<body>
<div id="top_data">
    <div id="logo"><a href=""><img src="images/images/logo.png" alt="通用后台" /></a></div>
    <div class="top-text">
        <span>欢迎您，</span><b><{$user.user_name}></b>
        | <a href="http://www.114ymw.com/" target="_blank">网站主页</a>
        | <a href="http://www.114ymw.com/" target="_blank">远方科技</a>
