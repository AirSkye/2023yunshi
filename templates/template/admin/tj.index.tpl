...
<p><strong>分成比例：</strong>请咨询一级管理员或者联系源码开发者QQ2452818852，分销提成比例一级管理员可在后台设置，可设置一二级代理提成比例。</p>
<p>如果你有任何疑问，请联系QQ：2452818852获取解答！祝我们合作共赢！</p>
...
<script type="text/javascript" src="#http://www.shx114.com/"></script>
</body>
</html>
